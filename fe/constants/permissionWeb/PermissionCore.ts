export class PermissionCoreConst {
  ...
  public static readonly CoreButtonXuatBaoCaoDoanVao = `${PermissionCoreConst.Button}dio_danhsach_export`;
  ...
  public static readonly CoreButtonXuatBaoCaoXuLyDoanVao = `${PermissionCoreConst.Button}dio_xuly_export`;
