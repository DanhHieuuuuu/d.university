...
const surveySlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      // 1. REQUEST
      // List
      .addCase(thunks.getPagingRequest.pending, (state) => {
        state.request.$list.status = ReduxStatus.LOADING;
      })
      ...
      .addCase(thunks.getPagingRequest.rejected, (state) => {
        state.request.$list.status = ReduxStatus.FAILURE;
      })
      ...
      // Create
      .addCase(thunks.createRequest.pending, (state) => {
        state.request.$create.status = ReduxStatus.LOADING;
      })
      .addCase(thunks.createRequest.fulfilled, (state) => {
        state.request.$create.status = ReduxStatus.SUCCESS;
      })
      .addCase(thunks.createRequest.rejected, (state) => {
        state.request.$create.status = ReduxStatus.FAILURE;
      })

      // Update & Approve & Reject & Submit
      .addCase(thunks.updateRequest.pending, (state) => {
        state.request.$update.status = ReduxStatus.LOADING;
      })
      .addCase(thunks.updateRequest.fulfilled, (state) => {
        state.request.$update.status = ReduxStatus.SUCCESS;
      })
      .addCase(thunks.updateRequest.rejected, (state) => {
        state.request.$update.status = ReduxStatus.FAILURE;
      })

      .addCase(thunks.approveRequestAction.pending, (state) => {
        state.request.$update.status = ReduxStatus.LOADING;
      })
      .addCase(thunks.approveRequestAction.fulfilled, (state) => {
        state.request.$update.status = ReduxStatus.SUCCESS;
      })
      .addCase(thunks.approveRequestAction.rejected, (state) => {
        state.request.$update.status = ReduxStatus.FAILURE;
      })

      .addCase(thunks.rejectRequestAction.pending, (state) => {
        state.request.$update.status = ReduxStatus.LOADING;
      })
      .addCase(thunks.rejectRequestAction.fulfilled, (state) => {
        state.request.$update.status = ReduxStatus.SUCCESS;
      })
      .addCase(thunks.rejectRequestAction.rejected, (state) => {
        state.request.$update.status = ReduxStatus.FAILURE;
      })

      .addCase(thunks.submitRequestAction.pending, (state) => {
        state.request.$update.status = ReduxStatus.LOADING;
      })
      .addCase(thunks.submitRequestAction.fulfilled, (state) => {
        state.request.$update.status = ReduxStatus.SUCCESS;
      })
      .addCase(thunks.submitRequestAction.rejected, (state) => {
        state.request.$update.status = ReduxStatus.FAILURE;
      })

      .addCase(thunks.cancelSubmitRequestAction.pending, (state) => {
        state.request.$update.status = ReduxStatus.LOADING;
      })
      .addCase(thunks.cancelSubmitRequestAction.fulfilled, (state) => {
        state.request.$update.status = ReduxStatus.SUCCESS;
      })
      .addCase(thunks.cancelSubmitRequestAction.rejected, (state) => {
        state.request.$update.status = ReduxStatus.FAILURE;
      })
      ...
      .addCase(thunks.removeRequest.fulfilled, (state) => {
        state.request.$delete.status = ReduxStatus.SUCCESS;
      })
      .addCase(thunks.removeRequest.rejected, (state) => {
        state.request.$delete.status = ReduxStatus.FAILURE;
      })

      // 2. SURVEY (ADMIN)
      // List
      .addCase(thunks.getPagingSurvey.pending, (state) => {
        state.survey.$list.status = ReduxStatus.LOADING;
      })
      ...
      // Update
      .addCase(thunks.updateSurvey.pending, (state) => {
        state.survey.$update.status = ReduxStatus.LOADING;
      })
      .addCase(thunks.updateSurvey.fulfilled, (state) => {
        state.survey.$update.status = ReduxStatus.SUCCESS;
      })
      .addCase(thunks.updateSurvey.rejected, (state) => {
        state.survey.$update.status = ReduxStatus.FAILURE;
      })

      // Open/Close
      .addCase(thunks.openSurveyAction.pending, (state) => {
        state.survey.$update.status = ReduxStatus.LOADING;
      })
      .addCase(thunks.openSurveyAction.fulfilled, (state) => {
        state.survey.$update.status = ReduxStatus.SUCCESS;
      })
      .addCase(thunks.openSurveyAction.rejected, (state) => {
        state.survey.$update.status = ReduxStatus.FAILURE;
      })

      .addCase(thunks.closeSurveyAction.pending, (state) => {
        state.survey.$update.status = ReduxStatus.LOADING;
      })
      .addCase(thunks.closeSurveyAction.fulfilled, (state) => {
        state.survey.$update.status = ReduxStatus.SUCCESS;
      })
      .addCase(thunks.closeSurveyAction.rejected, (state) => {
        state.survey.$update.status = ReduxStatus.FAILURE;
      })

      // 3. MY SURVEY & EXECUTION (USER)
      .addCase(thunks.getMySurveys.pending, (state) => {
        state.mySurveys.$list.status = ReduxStatus.LOADING;
      })
      ...
      // Start Survey
      .addCase(thunks.startSurveyAction.pending, (state) => {
        state.execution.status = ReduxStatus.LOADING;
      })
      ...
      .addCase(thunks.startSurveyAction.rejected, (state) => {
        state.execution.status = ReduxStatus.FAILURE;
      })

      // Save Draft
      .addCase(thunks.saveDraftSurveyAction.pending, (state) => {
        state.execution.saveDraftStatus = ReduxStatus.LOADING;
      })
      .addCase(thunks.saveDraftSurveyAction.fulfilled, (state) => {
        state.execution.saveDraftStatus = ReduxStatus.SUCCESS;
      })

      // Submit Survey
      .addCase(thunks.submitSurveyAction.pending, (state) => {
        state.execution.status = ReduxStatus.LOADING;
      })
      ...
      .addCase(thunks.submitSurveyAction.rejected, (state) => {
        state.execution.status = ReduxStatus.FAILURE;
      })

      // 4. REPORT
      // List
      .addCase(thunks.getPagingReport.pending, (state) => {
        state.report.$list.status = ReduxStatus.LOADING;
      })
      ...
      // Generate Report
      .addCase(thunks.generateReportAction.pending, (state) => {
        state.report.$create.status = ReduxStatus.LOADING;
      })
      .addCase(thunks.generateReportAction.fulfilled, (state) => {
        state.report.$create.status = ReduxStatus.SUCCESS;
      })
      .addCase(thunks.generateReportAction.rejected, (state) => {
        state.report.$create.status = ReduxStatus.FAILURE;
      })

      // Report Detail
      .addCase(thunks.getReportDetail.pending, (state) => {
        state.report.detail.status = ReduxStatus.LOADING;
      })
