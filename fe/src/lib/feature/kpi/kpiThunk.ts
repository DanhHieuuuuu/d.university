...
export const getAllIdsKpiCaNhan = createAsyncThunk('kpi-canhan/getAllIds', async (payload: IQueryKpiCaNhan) => {
  try {
    const res = await KpiService.getListKpiCaNhan(payload);
...
export const getListTrangThaiKpiCaNhan = createAsyncThunk('kpiCaNhan/getListTrangThai', async () => {
...
export const getAllIdsKpiDonVi = createAsyncThunk('kpi-donvi/getAllIds', async (payload: IQueryKpiDonVi) => {
  try {
    const res = await KpiService.getListKpiDonVi(payload);
    const items = res?.data?.items;
...
export const deleteKpiDonVi = createAsyncThunk('kpi/delete-donvi', async (id: number, { rejectWithValue }) => {
  try {
...
export const getListNamHocKpiDonVi = createAsyncThunk('kpiDonVi/getListNamHoc', async () => {
  return await KpiService.getListNamHocKpiDonVi();
});

export const getListTrangThaiKpiDonVi = createAsyncThunk('kpiDonVi/getListTrangThai', async () => {
...
export const giaoKpiDonVi = createAsyncThunk(
  ...
  async (payload: IGiaoKpiDonVi, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(error?.response?.data || { message: 'Giao KPI thất bại' });
    }
  }
);
...
export const getNhanSuDaGiaoByKpiDonVi = createAsyncThunk(
  ...
  async (idKpiDonVi: number, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(err?.message || 'Không lấy được nhân sự đã giao KPI');
    }
  }
);
// Kpi trường
...
export const deleteKpiTruong = createAsyncThunk('kpi/delete-truong', async (id: number, { rejectWithValue }) => {
  try {
...
export const getListNamHocKpiTruong = createAsyncThunk('kpiTruong/getListNamHoc', async () => {
  return await KpiService.getListNamHocKpiTruong();
});

export const getListTrangThaiKpiTruong = createAsyncThunk('kpiTruong/getListTrangThai', async () => {
  return await KpiService.getListTrangThaiKpiTruong();
});

export const getAllListKpiTruong = createAsyncThunk('kpiTruong/getAllList', async (_, { rejectWithValue }) => {
  try {
...
export const getAllIdsKpiRole = createAsyncThunk('kpi-role/getAllIds', async (payload: IQueryKpiRole) => {
  try {
...
export const createKpiRole = createAsyncThunk(
  'kpi-role/create',
  async (payload: ICreateKpiRole, { rejectWithValue }) => {
    try {
...
export const updateKpiRole = createAsyncThunk(
  'kpi-role/update',
  async (payload: IUpdateKpiRole, { rejectWithValue }) => {
    try {
...
export const getListKpiRoleByUser = createAsyncThunk('kpi-role/list-role-by-user', async () => {
...
//Kpi AI Chat
export const askKpiAi = createAsyncThunk('kpi/chat-ai', async (payload: IAskKpiChatCommand, { rejectWithValue }) => {
  try {
...
export const getKpiScoreBoard = createAsyncThunk(
  ...
  async (payload: IQueryKpiScoreBoard, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(error?.response?.data || { message: 'Lấy bảng thành tích thất bại' });
    }
  }
);
