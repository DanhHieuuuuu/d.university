...
namespace d.Shared.Permission.Permission
{
    public static class PermissionConfig
    {
        public static readonly Dictionary<string, CreatePermissionRequestDto> CoreConfigs = new()
        {
            ...
            { PermissionCoreKeys.CoreButtonBaoCaoXuLyDoanVao, new CreatePermissionRequestDto { PermissonKey= PermissionCoreKeys.CoreButtonBaoCaoXuLyDoanVao, PermissionName = "Báo cáo hoàn thành", ParentKey = PermissionCoreKeys.CoreMenuXuLyDoanVao } },
